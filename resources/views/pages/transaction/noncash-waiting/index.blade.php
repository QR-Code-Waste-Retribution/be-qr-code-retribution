            ...
            <div class="col-md-12">
               <div class="d-flex">
                    ...
                    <div class="d-flex ms-auto align-items-center">
                        <div class="">
                            <div class="px-2">
                                <a href="/transaction-noncash-waiting/{{$payment_via = $payment_status}}/payment/excel" class="btn btn-sm btn-success"><i class="bi bi-file-earmark-excel-fill"></i> Export to Excel</a>
                            </div>
                        </div>
